    ...
    >
      ...
      <div className="flex flex-col w-[50%] h-full space-y-4 text-white gap-10 justify-center">
        ...
        >
          ...
          facilis dignissimos fuga eveniet repellendus numquam vitae, corporis
          libero vel, deserunt, nulla reiciendis eligendi voluptate est
          provident? Ipsam odio libero quae modi, eveniet earum repudiandae
          excepturi exercitationem sint molestiae eaque corrupti unde a
          similique natus quas maiores porro reprehenderit dolorum corporis!
        </p>
        <button
